...
import { EditRule2Component } from './edit-rule.component';
import { isUndefined } from 'util';
import {Alert} from "../../../../common/util/alert.util";
import {HeaderRule} from "../../../../domain/data-preparation/prep-rules";

@Component({
  selector : 'edit-rule-header2',
  templateUrl : './edit-rule-header.component.html'
})
export class EditRuleHeader2Component extends EditRule2Component implements OnInit, AfterViewInit, OnDestroy {
  /*-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
  | Private Variables
  |-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=*/

...
package app.metatron.dataprep.transform;

import static app.metatron.dataprep.exception.PrepMessageKey.MSG_DP_ALERT_FAILED_TO_PARSE_JSON;
import static app.metatron.dataprep.transform.Histogram.Granule.DAY;
import static app.metatron.dataprep.transform.Histogram.Granule.HOUR;
import static app.metatron.dataprep.transform.Histogram.Granule.MILLIS;
import static app.metatron.dataprep.transform.Histogram.Granule.MINUTE;
import static app.metatron.dataprep.transform.Histogram.Granule.MONTH;
import static app.metatron.dataprep.transform.Histogram.Granule.NOT_USED;
import static app.metatron.dataprep.transform.Histogram.Granule.SECOND;
import static app.metatron.dataprep.transform.Histogram.Granule.YEAR;

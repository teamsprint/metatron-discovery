...
import app.metatron.dataprep.parser.antlr.RuleBaseVisitor;
import app.metatron.dataprep.parser.antlr.RuleLexer;
import app.metatron.dataprep.parser.antlr.RuleParser;
import app.metatron.dataprep.parser.exception.FunctionInvalidFunctionNameException;
import app.metatron.dataprep.parser.rule.Arguments;
import app.metatron.dataprep.parser.rule.Rule;
import app.metatron.dataprep.parser.rule.RuleBuilder;
      ...
      if (!Modifier.isAbstract(clazz.getModifiers()) && Function.class.isAssignableFrom(clazz)) {
        try {
          ...
          if (parent != BuiltinFunctions.class) {
            LOGGER.trace("UDF '" + name + "' registered with class " + clazz.getName());
          }
        } catch (Exception e) {

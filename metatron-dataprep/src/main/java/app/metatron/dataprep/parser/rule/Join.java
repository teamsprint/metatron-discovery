...
import static app.metatron.dataprep.parser.rule.Join.JOIN_TYPE.INVALID;
import static app.metatron.dataprep.parser.rule.Join.JOIN_TYPE.LEFT;
import static app.metatron.dataprep.parser.rule.Join.JOIN_TYPE.OUTER;
import static app.metatron.dataprep.parser.rule.Join.JOIN_TYPE.RIGHT;

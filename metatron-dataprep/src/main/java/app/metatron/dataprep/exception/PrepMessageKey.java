...
public enum PrepMessageKey {
  ...
  MSG_DP_ALERT_FAILED_TO_WRITE_JSON(                           "msg.dp.alert.failed.to.write.json"),
  MSG_DP_ALERT_FAILED_TO_WRITE_SQL(                            "msg.dp.alert.failed.to.write.sql"),
  ...
  MSG_DP_ALERT_SNAPSHOT_TYPE_IS_MISSING(                       "msg.dp.alert.snapshot.type.is.missing"),
  ...
  MSG_DP_ALERT_TEDDY_PARSE_FAILED_BY_UNNEST_COL(               "msg.dp.alert.teddy.parse.failed.by.unnest.col"),
  ...
  MSG_DP_ALERT_TEDDY_PARSE_FAILED_BY_UNION_DATASET2(           "msg.dp.alert.teddy.parse.failed.by.union.dataset2"),
  ...
  MSG_DP_ALERT_TEDDY_CANNOT_SERIALIZE_INTO_JSON(               "msg.dp.alter.teddy.cannot.serialize.into.json"),
  MSG_DP_ALERT_TEDDY_CANNOT_UNNEST_EMPTY_COLUMN(               "msg.dp.alter.teddy.cannot.unnest.empty.column"),

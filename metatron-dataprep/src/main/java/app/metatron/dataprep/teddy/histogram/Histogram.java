...
package app.metatron.dataprep.teddy.histogram;

import static app.metatron.dataprep.exception.PrepMessageKey.MSG_DP_ALERT_FAILED_TO_PARSE_JSON;
import static app.metatron.dataprep.teddy.histogram.Histogram.Granule.DAY;
import static app.metatron.dataprep.teddy.histogram.Histogram.Granule.HOUR;
import static app.metatron.dataprep.teddy.histogram.Histogram.Granule.MILLIS;
import static app.metatron.dataprep.teddy.histogram.Histogram.Granule.MINUTE;
import static app.metatron.dataprep.teddy.histogram.Histogram.Granule.MONTH;
import static app.metatron.dataprep.teddy.histogram.Histogram.Granule.NOT_USED;
import static app.metatron.dataprep.teddy.histogram.Histogram.Granule.SECOND;
import static app.metatron.dataprep.teddy.histogram.Histogram.Granule.YEAR;
import static app.metatron.dataprep.util.GlobalObjectMapper.getDefaultMapper;
import static app.metatron.dataprep.util.PrepUtil.transformError;

...
package app.metatron.dataprep.parser;
...
public class RuleVisitorParserTest {
  ...
  public void replaceTest() {
    ...
    assertEquals(
            "Replace{col=Category, on=/\\d{3}/, after=null, before=null, with='abc', global=true, ignoreCase=null, quote='', row=(sales > 10)}",
  ...
  public void replaceMultiColTest() {
    ...
    assertEquals(
            "Replace{col=[Category, name], on=/\\d{3}/, after=null, before=null, with='abc', global=true, ignoreCase=null, quote='', row=(sales > 10)}",
            runAndPrint(ruleCode));
  }
  ...
  public void countPatternMultiColTest() {
    ...
    assertEquals("CountPattern{col=[City, name], on=/H.*/, after=null, before=null, ignoreCase=true, quote=''}",
            runAndPrint(ruleCode));
  }
  ...
  public void windowTest() {
    String ruleCode = "window value: first(speed), rank() group: speed order: weigh, speed";
    assertEquals(
            "Window{value=FunctionArrayExpr{functions=[first(speed), rank()]}, order=[weigh, speed], group=speed, rowsBetween=null}",
            runAndPrint(ruleCode));
  }
